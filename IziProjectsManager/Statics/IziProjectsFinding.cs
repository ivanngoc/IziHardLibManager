    ...
    public static class IziProjectsFinding
    {
        ...
        public static async Task SearchOnly(DirectoryInfo dir, List<InfoBase> result, int depth, List<ItemsInFolder> itemsInFolders)
        {
            ...
            foreach (var fileInfo in files)
            {
                ...
                if (fileInfo.Name == InfoIziProjectsMeta.META_NAME)
                {
        ...
        /// <returns></returns>
        internal static async Task SearchForDependeciesForeignAsync(JsonObject config, List<InfoBase> result, List<InfoAsmdef> unityCache)
        {
        ...
        internal static async Task<List<InfoDependecy>> SearchForForeignAsmdefsDependecies(JsonObject config, IEnumerable<InfoAsmdef> myAsmdefs, List<InfoAsmdef> resultAsmdefs)
        {
            List<InfoDependecy> result = new List<InfoDependecy>();
        ...
        internal static InfoDependecy[] SearchForDlls(JsonObject config)
        {
            List<InfoDependecy> result = new List<InfoDependecy>();
        ...
        /// <returns></returns>
        internal static List<InfoDependecy> SearchForCsprojDlls(IEnumerable<InfoCsproj> csprojs)
        {
            List<InfoDependecy> result = new List<InfoDependecy>();
        ...
        internal static List<InfoRelation> SearchForDependeciesInnerAsync(List<InfoBase> items)
        {
#if DEBUG
        ...
        internal static CsprojFindResult FindAndUpdateCsproj(Guid guid, string pathAbs, string projectFileName, string projectName)
        {
        ...
        internal static async Task<List<InfoBase>> FindAllFromConfig()
        {
        ...
        internal static FileInfo? FindMainPackageJson(DirectoryInfo directory)
        {
        ...
        internal static FileInfo FindMainPackageJson(FileInfo packJson)
        {
        ...
        internal struct CsprojFindResult
        {
