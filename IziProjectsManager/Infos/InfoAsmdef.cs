...
{
    public class InfoAsmdef : InfoBase
    {
        ...
        public InfoAsmdef(FileInfo fileInfo) : base(fileInfo)
        {
        ...
        internal void SetPairCsproj(InfoCsproj proj)
        {
            this.infoProj = proj;
            SetPaired(proj);
        }

        internal bool IsUse(InfoAsmdef asmdef)
        {
        ...
        internal void FindConnectionsOwn(List<InfoRelation> result, Func<string, InfoAsmdef> findByGuid)
        {
            if (IsExecuted)
            {
        ...
        internal static bool IsValidExtension(FileInfo info)
        {
        ...
        internal async Task WriteGuidToFileAsync(Guid guidStruct)
        {
        ...
        internal static Guid FindGuid(JsonNode jsonNode)
        {
