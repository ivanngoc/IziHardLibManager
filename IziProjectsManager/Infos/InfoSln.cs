...
namespace IziHardGames.Projects
{
    public class InfoSln : InfoBase
    {
        ...
        internal void EnsureDependecy(IziModelCsproj csproj)
        {
            throw new System.NotImplementedException();
        }
        internal void EnsureDependecy(InfoCsproj csproj)
        {
            throw new System.NotImplementedException();
        }
        internal void AddOrUpdateDirty(InfoCsproj csproj)
        {
        ...
        internal void FindConnections(List<InfoRelation> result, Func<InfoItem, InfoCsproj> finder)
        {
