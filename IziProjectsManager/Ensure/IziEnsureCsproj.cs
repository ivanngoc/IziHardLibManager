...
namespace IziHardGames.Projects
{
    ...
    public static class IziEnsureCsproj
    {
        ...
        internal static Task EnsureUnityDll(string pathFull, Guid guid)
        {
        ...
        internal static async Task FormatDepencdecies(FileInfo file)
        {
