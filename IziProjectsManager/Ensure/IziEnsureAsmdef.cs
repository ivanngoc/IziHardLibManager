...
namespace IziHardGames.Projects
{
    public static class IziEnsureAsmdef
    {
        ...
        internal static async Task EnsureAsmdefFormatSingle(FileInfo file)
        {
        ...
        internal static async Task EnsureDependeciesJunctionsAsync(string asmdef)
        {
        ...
        internal static async Task EnsureDependeciesJunctionsAsync(DirectoryInfo directory, DirectoryInfo targetDir, FileInfo rootAsmdef)
        {
        ...
        /// <returns></returns>
        internal static async Task EnsureDependeciesJunctionsAsync(DirectoryInfo packagesDir, DirectoryInfo targetDir)
        {
            REPEAT:
        ...
        /// <returns></returns>
        internal static async Task<bool> EnsureDependeciesJunctionsAsync(FileInfo asmdefSource, DirectoryInfo target)
        {
