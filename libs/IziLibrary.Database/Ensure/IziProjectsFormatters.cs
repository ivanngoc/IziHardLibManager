...
namespace IziHardGames.Projects
{
    public static class IziProjectsFormatters
    {
        ...
        {
            FileInfo iziMetaInfo = new FileInfo(Path.Combine(dir.FullName, IziProjectsFinding.META_NAME));
            ...
            {
                meta = await IziProjectsFinding.CreateDefaultFileAsync(dir).ConfigureAwait(false);
            }
        ...
        public static async Task FormatAsmdefsNestedAsync(DirectoryInfo directory)
        {
        ...
        public static async Task FormatAsmdefsAsync(DirectoryInfo directory)
        {
        ...
        public static async Task FormatJsonPackageAsync(FileInfo fileInfo)
        {
            if (fileInfo.Exists)
            {
        ...
        public static async Task FormatJsonPackagesAsync(DirectoryInfo dir)
        {
