...
{
    public abstract class ModelFileUnit : ProjectItem
    {
        ...
        public ModelFileUnit()
        {

        }
        protected ModelFileUnit(InfoBase info)
        {
    ...
    public abstract class IziInProjectUnit : ModelFileUnit
    {
    ...
    public class IziModelDependecy : ModelFileUnit
    {
    ...
    public class IziModelInfoDll : ModelFileUnit
    {
    ...
    public class IziModelDll : ModelFileUnit
    {
        public IziModelDll()
        {
