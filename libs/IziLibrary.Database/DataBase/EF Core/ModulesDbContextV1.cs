...
{
    public class ModulesDbContextV1 : DbContext, IDataBaseAdapter
    {
        ...
        public static async Task ResolveDependecies(ModulesDbContextV1 context)
        {
        ...
        public async Task AddAsync(OldInfoAsmdef info)
        {
